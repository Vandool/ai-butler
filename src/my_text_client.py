...
def try_classifiers():
    ...
    llm_client = LLMClient(client=config.llm_url)
    few_shot_text_classifier = FewShotTextGenerationClassifier(llm_client=llm_client, intent_manager=intent_manager)
